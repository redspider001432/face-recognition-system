...
__all__ = [
    'SREHypothesis', 'SPEI_END_INPUT_STREAM', 'SAFTADPCM_8kHzMono',
    'DISPID_SASetState', 'SAFTCCITT_uLaw_11kHzStereo',
    'eLEXTYPE_PRIVATE19', 'SGRSTTWildcard', 'SAFTADPCM_11kHzStereo',
    'SDKLCurrentUser', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SPRules_NewEnum', 'DISPID_SVEAudioLevel',
    'DISPID_SPRulesCount', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SRTStandard', 'ISpPhoneticAlphabetConverter',
    'Speech_StreamPos_Asap', 'SPSHT_EMAIL', 'SAFT48kHz8BitStereo',
    'DISPID_SRProfile', 'SPWF_SRENGINE', 'SASClosed',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SPPParent',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SECHighConfidence', 'DISPID_SLWType',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SVSkip', 'SVP_1',
    'DISPID_SWFEFormatTag', 'SpWaveFormatEx', 'SpeechAllElements',
    'SpMMAudioEnum', 'SPINTERFERENCE_NOISE', 'SPEI_SR_BOOKMARK',
    'SRAExport', 'SRSEDone', 'SINoSignal', 'SAFT32kHz16BitStereo',
    'SDTPronunciation', 'DISPID_SLPPhoneIds', 'SPWT_PRONUNCIATION',
    'SVSFNLPMask', 'DISPID_SMSGetData', 'SVEStartInputStream',
    'ISpRecoGrammar', 'ISpeechRecoResultTimes',
    'DISPID_SRAudioInputStream', 'DISPID_SpeechDataKey',
    'DISPID_SpeechObjectToken', 'SpMMAudioIn', 'SPFM_CREATE_ALWAYS',
    'DISPID_SRCVoicePurgeEvent',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SABufferNotifySize',
    'DISPID_SPIEngineId', 'SVP_7', 'SPPS_Interjection',
    'DISPID_SOTGetDescription', 'SLOStatic',
    'SpeechGrammarTagDictation', 'DISPID_SGRsCount', 'ISpAudio',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SRStatus',
    'SpPhraseInfoBuilder', 'SGDSActiveWithAutoPause',
    'DISPID_SRGetFormat', 'ISpeechLexiconWords', 'SP_VISEME_17',
    'SVSFPurgeBeforeSpeak', 'ISpMMSysAudio', 'eLEXTYPE_RESERVED7',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SpeechLexicon',
    'DISPID_SRCPause', 'ISpeechBaseStream',
    'SWPKnownWordPronounceable', 'SAFT32kHz16BitMono', 'ISpStream',
    'DISPID_SGRSRule', 'DISPID_SRGCmdSetRuleState', 'DISPID_SOTId',
    'eLEXTYPE_MORPHOLOGY', 'SREStreamEnd', 'SPPS_Unknown',
    'DISPID_SBSWrite', 'DISPID_SGRAttributes', 'SVP_11',
    'DISPID_SRCRecognizer', '_ISpeechRecoContextEvents',
    'SPEI_RESERVED3', 'eLEXTYPE_PRIVATE10', 'DISPID_SPRText',
    'SITooFast', 'SFTInput', 'SECFIgnoreCase', 'DISPIDSPRG',
    'DISPID_SLPs_NewEnum', 'DISPID_SpeechAudioBufferInfo',
    'SP_VISEME_6', 'UINT_PTR', 'DISPID_SPEsCount',
    'SpeechTokenKeyAttributes', 'SPSEMANTICERRORINFO',
    'DISPID_SOTCategory', 'SpeechAudioProperties',
    'SRADefaultToActive', 'SpeechGrammarRuleStateTransitionType',
    'eLEXTYPE_PRIVATE17', 'SPFM_OPEN_READONLY',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SRCCmdMaxAlternates',
    'SPPROPERTYINFO', 'SVSFlagsAsync',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SLAddPronunciation',
    'SWTDeleted', 'SDKLDefaultLocation', 'DISPID_SVEEnginePrivate',
    'SPINTERFERENCE_TOOQUIET', 'ISpeechRecognizerStatus',
    'SGDSActive', 'SDA_Two_Trailing_Spaces',
    'SWPUnknownWordUnpronounceable', 'SpeechRecoEvents',
    'SPINTERFERENCE', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SRCEBookmark', 'DISPID_SPIGetText',
    'DISPID_SLRemovePronunciation', 'DISPID_SRCEventInterests',
    'SAFT8kHz16BitMono', 'DISPID_SRCCreateResultFromMemory',
    'eLEXTYPE_PRIVATE15', 'SLTUser', 'DISPID_SVGetAudioOutputs',
    'ISpeechRecoResult2', 'DISPID_SRIsShared', 'SVSFParseSsml',
    'SAFTCCITT_ALaw_44kHzMono', 'SpeechFormatType', 'SVSFParseSapi',
    'DISPID_SDKDeleteValue', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SGRSTWeight', 'DISPID_SDKSetStringValue', 'SPPS_Noun',
    'DISPID_SPRuleChildren', 'DISPID_SOTsCount', 'SAFT12kHz16BitMono',
    'SPAS_CLOSED', 'SpUnCompressedLexicon',
    'DISPID_SRGetPropertyNumber', 'SP_VISEME_5',
    'SpeechGrammarWordType', 'DISPID_SMSAMMHandle',
    'DISPID_SRCESoundStart', 'ISpStreamFormat', 'SVP_12',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SPIAudioSizeBytes',
    'SVEAudioLevel', 'DISPID_SRCERequestUI', 'ISpPhrase',
    'SpeechRegistryUserRoot', 'DISPID_SVDisplayUI',
    'SPWORDPRONOUNCEABLE', 'DISPID_SPCLangId', 'SAFT8kHz8BitMono',
    'SPCS_ENABLED', 'SPEI_PROPERTY_NUM_CHANGE', 'SAFTGSM610_8kHzMono',
    'SAFTGSM610_44kHzMono', 'SPRST_INACTIVE_WITH_PURGE',
    'SP_VISEME_19', 'DISPID_SPIReplacements', 'SDTProperty',
    'SGPronounciation', 'SpeechCategoryRecoProfiles',
    'SpeechRecoContextState', 'SPSVerb', 'SPPHRASEPROPERTY',
    'SP_VISEME_9', 'DISPID_SRCResume', 'DISPID_SPEActualConfidence',
    'DISPID_SPEsItem', 'eLEXTYPE_RESERVED9', 'SAFT12kHz16BitStereo',
    'SpeechStreamSeekPositionType', 'SpeechUserTraining',
    'SAFT32kHz8BitStereo', 'ISpeechResourceLoader', 'DISPID_SLWsItem',
    'DISPID_SPPId', 'SVPOver', 'DISPID_SpeechPhraseProperties',
    'SWTAdded', 'DISPID_SPILanguageId',
    'ISpPhoneticAlphabetSelection', 'SRAImport', 'SpResourceManager',
    'SPSTREAMFORMATTYPE', 'DISPID_SPRuleId', 'DISPID_SRState',
    'SPCT_SLEEP', 'DISPID_SGRSTPropertyValue',
    'DISPID_SVSRunningState', 'SRARoot', 'SSTTDictation',
    'DISPID_SLWWord', 'STSF_CommonAppData',
    'SpeechCategoryRecognizers', 'ISpeechFileStream',
    'DISPID_SVSpeakStream', 'DISPID_SpeechLexiconWords',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SPIGetDisplayAttributes',
    'SAFTADPCM_22kHzMono', 'SVP_19', 'SpeechLoadOption',
    'IInternetSecurityManager', 'DISPID_SGRSTsItem',
    'DISPID_SDKDeleteKey', 'SPINTERFERENCE_TOOSLOW',
    'SpeechBookmarkOptions', 'DISPID_SpeechRecoContext',
    'eLEXTYPE_RESERVED8', 'eLEXTYPE_PRIVATE1', 'SAFT16kHz8BitStereo',
    'SVP_21', 'ISpeechPhraseElements', 'DISPID_SRRSpeakAudio',
    'DISPID_SMSSetData', 'DISPID_SpeechRecoResult',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'ISpRecognizer2',
    'SAFTADPCM_44kHzStereo', 'DISPID_SOTMatchesAttributes',
    'DISPID_SRGDictationLoad', 'DISPID_SPANumberOfElementsInResult',
    'Speech_Max_Word_Length', 'SPSHORTCUTPAIR', 'SINoise',
    'SRCS_Disabled', 'DISPID_SRRPhraseInfo', 'DISPID_SVAlertBoundary',
    'ISpeechMemoryStream', 'ISpeechVoiceStatus', 'SPAR_High',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SRCBookmark',
    'ISpRecoResult', 'ISpResourceManager', 'SPVPRI_OVER',
    'SPBO_TIME_UNITS', 'DISPID_SpeechAudioFormat', 'DISPID_SVPause',
    'DISPID_SRCCreateGrammar', 'SDTReplacement',
    'SpeechCategoryAudioOut', 'DISPID_SOTGetStorageFileName',
    'DISPID_SPPs_NewEnum', 'DISPID_SRRAudio',
    'DISPID_SpeechRecoResult2', 'SpeechVoicePriority', 'SPBO_AHEAD',
    'SPINTERFERENCE_NONE', 'ISpVoice', 'SPPS_Verb',
    'DISPID_SPPEngineConfidence', 'SPWORD', 'DISPID_SGRId',
    'DISPID_SLPLangId', 'SP_VISEME_1', 'DISPID_SAFGuid',
    'DISPID_SPRs_NewEnum', 'DISPID_SFSClose', 'DISPID_SRCEHypothesis',
    'DISPID_SpeechPhoneConverter', 'SPPHRASERULE', 'SECLowConfidence',
    'SGDSInactive', 'DISPID_SDKSetLongValue',
    'DISPID_SPPFirstElement', 'SAFTADPCM_22kHzStereo',
    'eWORDTYPE_ADDED', 'SGSExclusive', 'SpeechRuleAttributes',
    'SVP_4', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SpeechPhraseElements', 'DISPID_SRCEStartStream',
    'DISPID_SPPChildren', 'DISPID_SRRTLength', 'eLEXTYPE_PRIVATE3',
    'SAFT22kHz8BitStereo', 'SVP_8', 'SPSUnknown',
    'DISPID_SOTRemoveStorageFileName',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SLWsCount',
    'ISpeechLexiconPronunciations', 'DISPID_SRGCmdLoadFromMemory',
    'eLEXTYPE_APP', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SRRDiscardResultInfo', 'SPRECOGNIZERSTATUS',
    'eLEXTYPE_RESERVED6', 'DISPID_SpeechPhraseRule',
    'DISPID_SRCRequestedUIType', 'IEnumString', 'SRCS_Enabled',
    'DISPID_SRRAudioFormat', 'SPEVENTSOURCEINFO',
    'DISPID_SCSBaseStream', 'DISPID_SDKSetBinaryValue',
    'SpeechCategoryAudioIn', 'SPEI_PHONEME', 'SPSLMA',
    'SpeechPropertyHighConfidenceThreshold', 'SAFT24kHz16BitMono',
    'DISPID_SRGetPropertyString', 'SP_VISEME_15',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SVVolume',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SAFTADPCM_44kHzMono',
    'SPEI_REQUEST_UI', 'SP_VISEME_20', 'SPEI_MIN_SR',
    'DISPID_SPEAudioSizeTime', 'ISpeechGrammarRules', 'SVP_3',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SGRsAdd',
    'SVESentenceBoundary', 'DISPID_SPEEngineConfidence',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SpeechAudio',
    'SpSharedRecognizer', 'DISPID_SAStatus', 'SVP_6',
    'SpeechEngineConfidence', 'DISPID_SPIEnginePrivateData',
    'SITooSlow', 'SP_VISEME_2', 'DISPID_SpeechGrammarRule',
    'SDTAlternates', 'SpeechVisemeFeature', 'SPSERIALIZEDRESULT',
    'SPSSuppressWord', 'DISPID_SVSyncronousSpeakTimeout',
    'SpNotifyTranslator', 'SGSEnabled', 'SpCustomStream',
    'SAFT16kHz16BitStereo', 'ISpeechLexicon',
    'DISPID_SpeechGrammarRuleState', 'SAFTCCITT_ALaw_22kHzStereo',
    'SVSFIsNotXML', 'DISPID_SRGSetTextSelection',
    'SPEI_WORD_BOUNDARY', 'SDA_No_Trailing_Space', 'SSTTTextBuffer',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SRSClsidEngine',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SVSLastBookmark',
    'SVPNormal', 'DISPID_SVSInputWordLength', 'SECFEmulateResult',
    'SLTApp', 'SAFT44kHz16BitMono', 'SPBOOKMARKOPTIONS',
    'SPEI_SOUND_START', 'SAFT12kHz8BitStereo', 'SGRSTTWord',
    'IStream', 'DISPID_SPAPhraseInfo', 'SpeechEngineProperties',
    'ISpeechPhraseRule', 'SAFT24kHz8BitStereo', 'SPFM_NUM_MODES',
    'DISPID_SREmulateRecognition', 'SREPropertyNumChange',
    'DISPID_SVRate', 'SpMemoryStream', 'SpeechDiscardType',
    'DISPID_SPPsCount', 'SPWT_LEXICAL', 'DISPID_SOTDataKey',
    'SpeechGrammarTagWildcard', 'eLEXTYPE_PRIVATE5',
    'SREFalseRecognition', 'SP_VISEME_18', 'SpeechTokenContext',
    'SRTSMLTimeout', 'DISPID_SVEPhoneme', 'SVP_18',
    'ISpeechRecoContext', 'SAFTCCITT_uLaw_22kHzStereo', 'SPAS_RUN',
    'SpeechTokenKeyFiles', 'DISPID_SRRSaveToMemory',
    'DISPID_SRGSetWordSequenceData', 'SPCS_DISABLED',
    'DISPID_SPIStartTime', 'SPEI_MAX_SR', 'SAFT22kHz16BitMono',
    'SAFT44kHz16BitStereo', 'SPSHORTCUTTYPE', 'SRADynamic',
    'SVSFDefault', 'DISPID_SpeechAudioStatus', 'SpVoice',
    'DISPID_SGRSTPropertyId', 'DISPID_SRGDictationSetState',
    'Speech_Default_Weight', 'eLEXTYPE_PRIVATE18',
    'SPTEXTSELECTIONINFO', 'DISPID_SGRSTText',
    'DISPID_SpeechPhraseElement', 'DISPID_SRSetPropertyNumber',
    'ISpeechPhraseInfoBuilder', 'SPPARTOFSPEECH', 'SPAR_Unknown',
    'SPAR_Low', 'SpeechVoiceSkipTypeSentence', 'SVSFUnusedFlags',
    'SSFMOpenReadWrite', 'SDTLexicalForm', 'ISpeechCustomStream',
    'DISPID_SPRNumberOfElements', '__MIDL_IWinTypes_0009',
    'DISPID_SRRAlternates', 'DISPID_SpeechVoice',
    'DISPID_SRRSetTextFeedback', 'SGDisplay',
    'DISPID_SRGDictationUnload', 'DISPID_SASState', 'SPAS_STOP',
    'DISPID_SOTsItem', 'SPPS_Modifier', 'eLEXTYPE_PRIVATE20',
    'eLEXTYPE_USER_SHORTCUT', 'STCInprocServer', 'DISPID_SVStatus',
    'SPDKL_DefaultLocation', 'SECNormalConfidence',
    'SPXRO_Alternates_SML', 'ISpRecoContext2', 'SVSFIsXML',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SMSALineId',
    'DISPID_SRGRecoContext', 'SPRECOCONTEXTSTATUS',
    'SpPhoneConverter', 'DISPID_SVSpeakCompleteEvent',
    'SPRS_ACTIVE_USER_DELIMITED',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SAFT8kHz8BitStereo',
    'SSSPTRelativeToEnd', 'DISPID_SOTRemove', 'ISpeechWaveFormatEx',
    'ISpeechPhraseElement', 'DISPID_SpeechVoiceEvent',
    'SPDATAKEYLOCATION', 'SVEPhoneme', 'DISPID_SpeechVoiceStatus',
    'DISPID_SPRsItem', 'DISPID_SGRAddResource',
    'DISPIDSPTSI_SelectionLength', 'SPRULESTATE',
    'SPEI_START_SR_STREAM', 'ISpPhoneConverter',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SpeechPhraseAlternate', 'SPPS_SuppressWord',
    'SRTEmulated', 'DISPID_SLAddPronunciationByPhoneIds',
    'SP_VISEME_3', 'SPCT_COMMAND', 'SpeechRegistryLocalMachineRoot',
    'SpLexicon', 'SpeechAudioVolume', 'DISPID_SRRTStreamTime',
    'DISPID_SPIProperties', 'DISPID_SpeechGrammarRuleStateTransition',
    'SPEI_VISEME', 'eLEXTYPE_PRIVATE11', 'DISPID_SRCVoice',
    'SPWORDTYPE', 'DISPID_SGRs_NewEnum', 'eLEXTYPE_PRIVATE14',
    'SPEI_VOICE_CHANGE', 'SpeechWordPronounceable', 'DISPID_SOTCId',
    'SAFT11kHz8BitMono', 'DISPID_SOTs_NewEnum',
    'DISPID_SRSetPropertyString', 'SRESoundEnd', 'SRESoundStart',
    'DISPID_SRRRecoContext', 'SPWAVEFORMATTYPE', 'ISpLexicon',
    'ISpeechPhraseRules', 'DISPID_SRSCurrentStreamNumber',
    'SPSFunction', 'SPSEMANTICFORMAT', 'SPPS_Function',
    'DISPID_SRSNumberOfActiveRules', 'ISpeechObjectToken', 'SASRun',
    'SRATopLevel', 'DISPID_SPEAudioTimeOffset', 'SPEI_RESERVED1',
    'SPEI_END_SR_STREAM', 'DISPID_SRCEAudioLevel',
    'ISpeechAudioFormat', 'SAFTCCITT_ALaw_8kHzStereo',
    'SVEVoiceChange', 'SPEI_TTS_PRIVATE', 'SpeechStreamFileMode',
    'DISPID_SRCEPropertyStringChange', 'SPEI_RECO_STATE_CHANGE',
    'SpeechPropertyComplexResponseSpeed', 'SPSNoun',
    'DISPID_SLPSymbolic', 'ISpNotifySink', 'DISPID_SABIBufferSize',
    'SSTTWildcard', 'DISPID_SGRAddState', 'SpeechRunState',
    'SPAUDIOSTATUS', 'IInternetSecurityMgrSite', 'SPCT_SUB_DICTATION',
    'SPEI_SR_PRIVATE', 'SFTSREngine', 'SpeechPropertyAdaptationOn',
    'ISpeechPhraseProperty', 'DISPID_SPRuleFirstElement',
    'DISPID_SpeechRecognizerStatus', 'SGRSTTRule',
    'SpeechEmulationCompareFlags', 'SPXMLRESULTOPTIONS',
    'SAFT16kHz8BitMono', 'SBOPause', 'ISpeechPhraseAlternates',
    'ISpeechLexiconPronunciation', 'DISPID_SLPPartOfSpeech',
    'SPEI_INTERFERENCE', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SADefaultFormat', 'SVEPrivate', 'DISPID_SRRTimes',
    'DISPID_SRCEInterference', 'DISPID_SpeechPhraseAlternates',
    'SAFT22kHz8BitMono', 'SPEI_SENTENCE_BOUNDARY', 'DISPID_SGRSTRule',
    'SAFT11kHz8BitStereo', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SPAS_PAUSE', 'SPEI_SOUND_END', 'DISPID_SPCIdToPhone',
    'DISPID_SVEViseme', 'DISPID_SpeechObjectTokens',
    'Speech_Max_Pron_Length', 'SAFTCCITT_ALaw_11kHzMono',
    'SVSFIsFilename', 'ISpeechRecoGrammar', 'DISPID_SRCERecognition',
    'DISPID_SpeechPhraseRules', 'SPSNotOverriden',
    'DISPID_SPRulesItem', 'DISPID_SOTCreateInstance',
    'eWORDTYPE_DELETED', 'DISPID_SGRsItem', 'eLEXTYPE_RESERVED10',
    'SpInProcRecoContext', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SOTDisplayUI', 'DISPID_SVEVoiceChange', 'DISPID_SVVoice',
    'SpeechAudioFormatGUIDWave', '_SPAUDIOSTATE', 'ISpeechVoice',
    'DISPID_SRCEEndStream', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'eLEXTYPE_PRIVATE9', 'SPFM_OPEN_READWRITE',
    'SPINTERFERENCE_LATENCY_WARNING', 'SAFTADPCM_11kHzMono',
    'SPCONTEXTSTATE', 'SASStop', 'ISpDataKey',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SPAsItem',
    'DISPID_SDKGetBinaryValue', 'ISpeechPhraseAlternate',
    'STCLocalServer', 'SITooLoud', 'SPRECOSTATE', 'DISPID_SBSFormat',
    'SAFTExtendedAudioFormat', 'SAFT11kHz16BitMono',
    'SAFTTrueSpeech_8kHz1BitMono', 'SP_VISEME_4', 'SVP_15',
    'DISPIDSPTSI_ActiveLength', 'SRTExtendableParse',
    'DISPID_SWFEBlockAlign', 'SDTDisplayText',
    'SpTextSelectionInformation', 'SpeechSpecialTransitionType',
    'IEnumSpObjectTokens', 'SpeechPropertyResourceUsage',
    'SREAudioLevel', 'DISPID_SGRSTPropertyName',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SPIRule',
    'DISPID_SpeechBaseStream', 'SAFTNoAssignedFormat',
    'DISPID_SpeechMemoryStream', 'ISpRecognizer3',
    'DISPID_SRGCmdLoadFromResource', 'SDA_Consume_Leading_Spaces',
    'SREPrivate', 'ISpProperties', 'SPEI_MIN_TTS', 'SPSInterjection',
    'SAFTNonStandardFormat', 'SRERequestUI',
    'ISpeechGrammarRuleState', 'DISPID_SDKEnumValues', 'SP_VISEME_21',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SRCreateRecoContext',
    'DISPID_SBSSeek', 'DISPID_SOTSetId', 'DISPID_SAFType',
    'SpeechTokenShellFolder', 'SAFT32kHz8BitMono',
    'SAFTCCITT_uLaw_8kHzStereo', 'ISpShortcut', 'SPGRAMMARWORDTYPE',
    'SPEI_START_INPUT_STREAM', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SLPsItem', 'SpeechInterference', 'tagSPPROPERTYINFO',
    'SGLexical', 'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SOTGetAttribute', 'DISPID_SLGenerationId',
    'DISPID_SLWs_NewEnum', 'SPEI_RECOGNITION', 'SECFDefault',
    'DISPID_SRCSetAdaptationData', 'STSF_LocalAppData',
    'SAFT44kHz8BitMono', 'SpeechPartOfSpeech',
    'ISpeechRecoResultDispatch', 'SDTAll', 'SPLEXICONTYPE',
    'DISPID_SRCEFalseRecognition', 'SBONone', 'tagSTATSTG',
    'SREPhraseStart', 'DISPID_SRGIsPronounceable', 'SVF_Emphasis',
    'SPLO_DYNAMIC', 'SPRST_ACTIVE_ALWAYS', 'SRSInactiveWithPurge',
    'DISPID_SASCurrentSeekPosition', 'SRSActive',
    'SSSPTRelativeToCurrentPosition', 'SpeechRecognitionType',
    'SPLOADOPTIONS', 'SVF_Stressed', 'SVP_9',
    'DISPID_SGRSTransitions', 'DISPID_SpeechRecognizer',
    'SDKLCurrentConfig', 'SPPHRASEREPLACEMENT',
    'ISpeechObjectTokenCategory', 'SDA_One_Trailing_Space',
    'DISPID_SPISaveToMemory', 'DISPID_SPAsCount',
    'SPEI_PROPERTY_STRING_CHANGE', 'SVSFPersistXML',
    'ISpSerializeState', 'DISPID_SPPConfidence',
    'DISPID_SPAs_NewEnum', 'SAFTCCITT_uLaw_44kHzStereo',
    'eLEXTYPE_PRIVATE12', 'SPCATEGORYTYPE', 'DISPID_SBSRead',
    'DISPID_SPRuleConfidence', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SRGState', 'ISpNotifySource', 'SSFMOpenForRead',
    'SVEWordBoundary', 'SAFT12kHz8BitMono', 'DISPID_SOTCDefault',
    'DISPID_SPELexicalForm', 'DISPID_SGRClear',
    'DISPID_SVSLastBookmarkId', 'DISPID_SVEBookmark',
    'SAFTCCITT_uLaw_11kHzMono', 'SpeechRuleState',
    'DISPID_SVAudioOutputStream', 'eLEXTYPE_PRIVATE4',
    'SPEI_TTS_BOOKMARK', 'DISPID_SGRsCommitAndSave',
    'DISPID_SPPsItem', 'DISPID_SDKEnumKeys', 'SLODynamic',
    'ISpeechAudioStatus', 'DISPID_SFSOpen', 'SpeechTokenValueCLSID',
    'SPEI_TTS_AUDIO_LEVEL', 'SPEI_PHRASE_START',
    'SpeechDisplayAttributes', 'DISPID_SGRName',
    'SWPUnknownWordPronounceable', 'SPPS_RESERVED4',
    'SpeechCategoryVoices', 'eLEXTYPE_PRIVATE8', 'SPLO_STATIC',
    'DISPID_SRCESoundEnd', 'SAFTGSM610_11kHzMono',
    'DISPID_SVESentenceBoundary', 'STSF_FlagCreate', 'SPSModifier',
    'SPRULE', 'SREPropertyStringChange', 'SPSHT_OTHER',
    'SPWT_DISPLAY', 'DISPID_SVSLastStreamNumberQueued',
    'SpStreamFormatConverter', 'SASPause', 'SVEBookmark',
    'SPFILEMODE', 'SPVISEMES', 'SP_VISEME_10', 'DISPID_SPARecoResult',
    'SPAUDIOBUFFERINFO', 'DISPID_SPPBRestorePhraseFromMemory',
    'SVSFParseAutodetect', 'DISPID_SDKOpenKey',
    'DISPID_SPERequiredConfidence', 'DISPID_SASNonBlockingIO',
    'SVP_5', 'DISPID_SVSInputSentenceLength', 'SPRECORESULTTIMES',
    'SVSFParseMask', 'DISPID_SPRuleNumberOfElements',
    'SREStreamStart', 'SPEVENT', 'SP_VISEME_8', 'ISpEventSink',
    'SRAInterpreter', 'DISPID_SRRecognizer', 'SPRS_INACTIVE',
    'SGLexicalNoSpecialChars', 'eLEXTYPE_USER', 'ISpeechMMSysAudio',
    'SAFTGSM610_22kHzMono', 'ISpeechPhoneConverter',
    'SAFTCCITT_ALaw_8kHzMono',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SAFSetWaveFormatEx', 'ISpPhraseAlt', 'DISPID_SVEWord',
    'SP_VISEME_0', 'DISPID_SRSSupportedLanguages',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SpObjectTokenCategory',
    'SP_VISEME_11', 'tagSPTEXTSELECTIONINFO', 'SSSPTRelativeToStart',
    'SPRS_ACTIVE', 'DISPID_SVGetAudioInputs',
    'DISPID_SRCEPhraseStart', 'DISPID_SRGCmdLoadFromFile',
    'ISpObjectToken', 'SPBINARYGRAMMAR',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SPRFirstElement',
    'SRERecoOtherContext', 'SPDKL_CurrentUser', 'SDTAudio',
    'DISPID_SRCEEnginePrivate', 'SpObjectToken',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SGRSAddWordTransition',
    'SVSFNLPSpeakPunc', 'SRTReSent', 'SPWF_INPUT', 'DISPID_SLPsCount',
    'SPSHORTCUTPAIRLIST', 'SSFMCreate', 'DISPID_SLGetPronunciations',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SVGetProfiles',
    'SGRSTTEpsilon', 'DISPID_SVSLastResult', 'SpSharedRecoContext',
    'ISpeechXMLRecoResult', 'SpeechPropertyResponseSpeed', 'SVP_13',
    'SPSHT_NotOverriden', 'SAFTADPCM_8kHzStereo', 'SpFileStream',
    'SpInprocRecognizer', 'DISPID_SPEAudioSizeBytes',
    'SPGRAMMARSTATE', 'ISpObjectWithToken',
    'DISPID_SASFreeBufferSpace', 'DISPID_SPRuleParent',
    'DISPID_SWFEExtraData', 'DISPID_SVAudioOutput',
    'SpeechDataKeyLocation', 'SITooQuiet', 'DISPID_SLGetWords',
    'DISPID_SRAudioInput', 'SpAudioFormat', 'SpeechGrammarState',
    'SPEI_HYPOTHESIS', 'ISpXMLRecoResult', 'DISPID_SGRSTType',
    'SPAR_Medium', 'DISPID_SVWaitUntilDone', 'DISPID_SLWLangId',
    'SPEI_RESERVED2', 'DISPID_SRDisplayUI', 'SAFT48kHz8BitMono',
    'DISPID_SPEPronunciation', 'DISPID_SLPType',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SVSPhonemeId', 'STCAll',
    'SPSMF_SAPI_PROPERTIES', 'ISpRecoContext',
    'DISPID_SVEventInterests', 'SAFTDefault', 'SPEI_UNDEFINED',
    'DISPID_SVSpeak', 'DISPID_SVIsUISupported', 'SpeechLexiconType',
    'DISPID_SVPriority', 'ISpeechGrammarRule',
    'DISPID_SDKGetlongValue', 'SVP_20', 'SAFT22kHz16BitStereo',
    'SPAUDIOOPTIONS', 'ISpeechPhraseReplacements', 'SPVPRI_NORMAL',
    'SPPHRASEELEMENT', 'DISPID_SABufferInfo',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SPEDisplayAttributes',
    'SAFTCCITT_ALaw_11kHzStereo', 'SAFT24kHz16BitStereo',
    'SRSInactive', 'STCInprocHandler', 'SINone', 'SPEI_MAX_TTS',
    'DISPID_SWFEBitsPerSample', 'ISpRecognizer',
    'DISPID_SpeechFileStream', 'DISPID_SpeechLexiconWord',
    'DISPID_SVSCurrentStreamNumber', 'SpPhoneticAlphabetConverter',
    'SRAONone', 'SPAO_RETAIN_AUDIO', 'ISpeechPhraseReplacement',
    'SGSDisabled', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SLWPronunciations', 'SGRSTTDictation',
    'SVEEndInputStream', 'DISPID_SPIRetainedSizeBytes', 'SVF_None',
    'DISPID_SRGReset', 'SPEI_SR_AUDIO_LEVEL', 'DISPID_SVEStreamEnd',
    'SPPHRASE', 'SVEViseme', 'DISPID_SPERetainedStreamOffset',
    'SPEVENTENUM', 'SpeechMicTraining', 'DISPID_SABIMinNotification',
    'DISPID_SPRsCount', 'DISPID_SPAStartElementInResult',
    'DISPID_SRCEAdaptation', 'SpeechAudioState', 'SECFIgnoreKanaType',
    'eLEXTYPE_PRIVATE2', 'SP_VISEME_16', 'eLEXTYPE_PRIVATE6',
    'eLEXTYPE_PRIVATE13', 'SpeechVoiceEvents', 'SPGS_ENABLED',
    'SPGS_EXCLUSIVE', 'ISpeechPhraseProperties',
    'SPADAPTATIONRELEVANCE', 'SPFM_CREATE',
    'DISPID_SVSInputWordPosition', 'SPAO_NONE', 'SRERecognition',
    'SpeechRetainedAudioOptions', 'SECFNoSpecialChars',
    'DISPID_SRGRules', 'SPEI_RESERVED6', 'DISPID_SRCState',
    'DISPID_SAVolume', 'DISPID_SRSAudioStatus', 'SREStateChange',
    'DISPID_SRCAudioInInterferenceStatus',
    'DISPIDSPTSI_SelectionOffset', 'eLEXTYPE_LETTERTOSOUND',
    'eLEXTYPE_PRIVATE16', 'ISpEventSource', 'SAFT48kHz16BitStereo',
    'DISPID_SMSADeviceId', 'ISpeechTextSelectionInformation',
    'ISpeechRecoResult', 'DISPID_SPEDisplayText',
    'SpCompressedLexicon', 'DISPID_SVSInputSentencePosition',
    'SPDKL_CurrentConfig', 'SpShortcut', 'DISPID_SRGCommit',
    'DISPID_SPIGrammarId', 'SPPS_RESERVED1', 'SVP_14',
    'SpeechAddRemoveWord', 'SAFTCCITT_uLaw_44kHzMono', 'SVP_2',
    'DISPID_SPIElements', 'DISPID_SPPName', 'SPEI_ADAPTATION',
    'SPEI_RESERVED5', 'SpeechVisemeType', 'DISPID_SGRSTNextState',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SPACommit', 'ISequentialStream',
    'DISPID_SRGetRecognizers', 'DISPID_SLGetGenerationChange',
    'SGRSTTTextBuffer', 'DISPID_SABIEventBias',
    'ISpeechGrammarRuleStateTransition', 'STCRemoteServer',
    'SPCT_SUB_COMMAND', 'SPSERIALIZEDPHRASE',
    'ISpeechAudioBufferInfo', 'DISPID_SPPNumberOfElements',
    'ISpeechPhraseInfo', 'DISPID_SRIsUISupported',
    'SPEI_FALSE_RECOGNITION', 'SAFT48kHz16BitMono',
    'SAFT44kHz8BitStereo', 'SP_VISEME_7', 'Speech_StreamPos_RealTime',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SRCRetainedAudio',
    'SPINTERFERENCE_NOSIGNAL', 'WAVEFORMATEX', 'DISPID_SGRsDynamic',
    'eLEXTYPE_PRIVATE7', 'DISPID_SRRTTickCount', 'SECFIgnoreWidth',
    'ISpeechAudio', 'SAFT16kHz16BitMono', 'SpeechWordType',
    'SP_VISEME_13', 'DISPID_SGRSTs_NewEnum', 'SPSMF_UPS',
    'ISpeechRecognizer', 'DISPID_SpeechCustomStream',
    '_ISpeechVoiceEvents', 'SAFTCCITT_ALaw_22kHzMono', 'LONG_PTR',
    'SpeechVoiceSpeakFlags', 'DISPID_SPRuleName',
    'DISPID_SDKCreateKey', 'SPPS_RESERVED3', 'ISpNotifyTranslator',
    'SPVOICESTATUS', 'DISPID_SAEventHandle', 'SP_VISEME_14',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SGRSAddRuleTransition',
    'SpeechDictationTopicSpelling', 'SGDSActiveUserDelimited',
    'SpeechTokenKeyUI', 'SpeechCategoryPhoneConverters',
    'SREAdaptation', 'SpeechTokenIdUserLexicon', 'ISpRecoGrammar2',
    'SpMMAudioOut', 'DISPID_SOTIsUISupported', 'SPXRO_SML', 'SVP_0',
    'SPINTERFERENCE_TOOLOUD', 'SPWORDLIST', 'SRSEIsSpeaking',
    'ISpeechLexiconWord', 'SP_VISEME_12', 'SpStream', 'SPAUDIOSTATE',
    'SPRST_INACTIVE', 'SpeechCategoryAppLexicons', 'SPVPRIORITY',
    'SPPS_RESERVED2', 'DISPID_SGRsCommit', 'SpeechRecognizerState',
    'DISPID_SpeechPhraseProperty', 'DISPID_SOTCGetDataKey',
    'DISPID_SWFEChannels', 'SPWORDPRONUNCIATION', 'SPPS_Noncontent',
    'DISPID_SGRSTsCount', 'ISpeechObjectTokens',
    'DISPID_SRGCmdLoadFromObject', 'SREBookmark',
    'SpeechRecoProfileProperties', 'SPSHT_Unknown',
    'SDKLLocalMachine', 'SPVPRI_ALERT', 'DISPID_SRRGetXMLResult',
    '_RemotableHandle', 'DISPID_SAFGetWaveFormatEx', 'DISPID_SRGId',
    'DISPID_SpeechPhraseInfo', 'SPCT_DICTATION', 'SVEAllEvents',
    'SAFT11kHz16BitStereo', 'SRTAutopause', 'DISPID_SOTCSetId',
    'DISPID_SGRSAddSpecialTransition', 'SpeechAudioFormatGUIDText',
    'ISpObjectTokenCategory', 'SVP_10', 'SPBO_NONE',
    'DISPID_SPEs_NewEnum', 'SpeechAudioFormatType',
    'eLEXTYPE_RESERVED4', 'SPGS_DISABLED',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SWFESamplesPerSec',
    'DISPID_SVResume', 'SVP_16', 'DISPID_SPIAudioSizeTime',
    'DISPID_SPRDisplayAttributes', 'SPRST_NUM_STATES',
    'ISpRecoCategory', 'DISPID_SVGetVoices', 'ISpeechDataKey',
    'DISPID_SGRsFindRule', 'SRAORetainAudio', 'SREAllEvents',
    'SAFT24kHz8BitMono', 'SRSActiveAlways', 'SDTRule',
    'DISPID_SpeechGrammarRules', 'STSF_AppData', 'SPRST_ACTIVE',
    'DISPID_SPPValue', 'DISPID_SVEStreamStart', 'SSFMCreateForWrite',
    'SPDKL_LocalMachine', 'DISPID_SDKGetStringValue',
    'DISPID_SPRuleEngineConfidence', 'SVSFVoiceMask',
    'SAFT8kHz16BitStereo', 'DISPID_SpeechMMSysAudio',
    'ISpGrammarBuilder', 'SVP_17', 'SPPS_LMA', 'SAFTText',
    'ISpStreamFormatConverter', 'DISPID_SRCRetainedAudioFormat',
    'SREInterference', 'DISPIDSPTSI', 'SPPS_NotOverriden',
    'DISPID_SPIAudioStreamPosition', 'SVPAlert', 'SPBO_PAUSE',
    'DISPID_SVSVisemeId', 'DISPID_SGRInitialState',
    'SpNullPhoneConverter', 'DISPID_SpeechLexiconProns',
    'DISPID_SPCPhoneToId'
]
